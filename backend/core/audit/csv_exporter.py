...
class AuditCSVExporter:
    ...
    def export_agent_decisions(self) -> Path:
        ...
        fieldnames = [
            'timestamp', 'agent_name', 'agent_element', 'symbol', 
            'action', 'confidence', 'strength', 'reasoning',
            'prana_level', 'guna_sattva', 'guna_rajas', 'guna_tamas'
        ]
    ...
    def export_collective_decisions(self) -> Path:
        ...
        fieldnames = [
            'timestamp', 'session_id', 'symbol', 'final_action', 
            'final_confidence', 'coherence', 'harmony_score',
            'weighted_strength', 'dominant_element', 'suppressed_element',
            'guna_dominant', 'guna_sattva', 'guna_rajas', 'guna_tamas',
            'is_maya', 'maya_score', 'maya_reason',
        ...
        print(f"  Exported {len(self.data['collective_deliberations'])} collective decisions to {output_file}")
        return output_file
    ...
    def export_risk_checks(self) -> Path:
        ...
        fieldnames = [
            'timestamp', 'session_id', 'symbol', 'sector',
            'passed', 'rejection_reason',
            'harmony_check', 'harmony_score',
            'maya_check', 'drawdown_check', 'current_drawdown',
            'position_limit_check', 'active_positions', 'sector_exposure'
        ]
    ...
    def export_position_sizing(self) -> Path:
        ...
        fieldnames = [
            ...
            'capital', 'base_risk', 'confidence', 'harmony', 'guna_dominant',
            'atr', 'price', 'calculated_size', 'max_position', 'final_size',
            'confidence_mult', 'harmony_mult', 'guna_mult', 'strategic_mult'
        ]
        ...
        print(f"  Exported {len(self.data['position_sizing'])} sizing calculations to {output_file}")
        return output_file
    ...
    def export_trade_executions(self) -> Path:
        ...
        fieldnames = [
            'timestamp', 'session_id', 'trade_id', 'symbol', 'side',
            'size', 'price', 'atr', 'stop_price', 'tp_price', 'trailing_mult',
            'transaction_cost', 'slippage_cost', 'total_cost',
            'market_regime', 'trend_1d', 'adx', 'rsi',
    ...
    def export_trade_exits(self) -> Path:
        ...
        fieldnames = [
            ...
            'gross_pnl', 'exit_costs', 'net_pnl', 'return_pct',
            'entry_harmony'
        ]
    ...
    def export_summary(self) -> Path:
        ...
        with open(output_file, 'w', newline='', encoding='utf-8') as f:
            ...
            summary_data = [
                ...
                {'metric': 'collective_deliberations', 'value': len(self.data['collective_deliberations'])},
    ...
    def create_excel_summary(self) -> Path:
        ...
        fieldnames = [
            'symbol', 'final_action', 'harmony_score', 'coherence', 
            'is_maya', 'guna_dominant', 'dominant_element',
            'trade_executed', 'exit_reason', 'net_pnl', 'bars_held'
        ]
        ...
        print(f"  Created Excel pivot data ({len(self.data['trade_executions'])} rows) to {output_file}")
        return output_file
