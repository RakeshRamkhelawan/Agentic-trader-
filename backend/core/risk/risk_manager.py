...
from backend.core.risk.mifid_checks import MiFIDGuard, ClientProfile, TradeRequest, ComplianceStatus
...
class RiskManager:
    ...
    def evaluate_trade(self, profile: ClientProfile, trade: TradeRequest, current_guna: GunaType) -> RiskDecision:
