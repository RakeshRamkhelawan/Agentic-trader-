...
SATTVA_KEYWORDS = frozenset([
    "stable", "growth", "predictable", "healthy", "balanced",
    "calm", "objective", "factual", "clear", "steady",
    "sustainable", "organic", "measured", "rational", "prudent",
    "conservative", "sound", "secure", "resilient", "durable",
    "consistent", "reliable", "methodical", "systematic", "disciplined",
])

RAJAS_KEYWORDS = frozenset([
    "surges", "jumps", "rises", "falls", "breakout",
    "action", "volatility", "movement", "change", "momentum",
    "buy", "sell", "urgent", "breaking", "rally",
    "squeeze", "liquidation", "pump", "fomo", "crash",
    "explosive", "volatile", "aggressive", "active", "dynamic",
    "breakout", "breakdown", "gap", "spike", "dump",
    "raging", "frenzy", "mania", "panic", "hysteria",
    "acceleration", "momentum", "trend", "surge", "jump",
])

TAMAS_KEYWORDS = frozenset([
    "crash", "fear", "panic", "collapse", "stagnant",
    "bear", "crisis", "tension", "uncertainty", "frozen",
    "resist", "chaos", "downturn", "recession", "depression",
    "uncertainty", "confusion", "doubt", "hesitation", "paralysis",
    "stagnation", "inertia", "resistance", "congestion", "rangebound",
    "consolidation", "sideways", "choppy", "noisy", "unclear",
    "bearish", "pessimistic", "negative", "decline", "falling",
])
