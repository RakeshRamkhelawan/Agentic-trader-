...
class DashaStrategyMap:
    ...
    def __init__(self):
        ...
        self.planet_map = {
            ...
            "Venus": {
                "risk": RiskProfile.MODERATE,
                "horizon": TimeHorizon.SWING,
                "asset": [AssetPreference.VALUE, AssetPreference.MOMENTUM], # Reversion?
    ...
    def get_strategy_config(self, mahadasha: str, antardasha: str) -> StrategyConfig:
        ...
        if maha_props["horizon"] == TimeHorizon.POSITION and antar_props["horizon"] == TimeHorizon.SCALP:
            horizon = TimeHorizon.INTRADAY
        elif maha_props["horizon"] == TimeHorizon.POSITION and antar_props["horizon"] == TimeHorizon.INTRADAY:
            horizon = TimeHorizon.SWING
        else:
