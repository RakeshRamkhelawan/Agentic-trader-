...
async def get_prediction_signals(
    market: Optional[str] = Query(
        None,
        description="Filter by market: kalshi, polymarket"
    ),
    category: Optional[str] = Query(
        None,
        description="Filter by category: crypto, politics, etc"
    ),
    signal_type: Optional[str] = Query(
        None,
        description="Filter by signal type: bullish, bearish, neutral"
    ),
    ...
    symbol: Optional[str] = Query(
        None,
        description="Filter by trading symbol: BTC, ETH, etc"
    ),
