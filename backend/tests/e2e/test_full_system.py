...
from backend.core.telemetry.tracing import TraceCorrelation
...
class TestFullSystemE2E:
    ...
    async def test_vedastro_to_tattva_pipeline(self):
        ...
        orchestrator = TattvaOrchestrator(min_coherence=0.5, tamas_threshold=0.6)
        ...
        tick = {
            "price": 45000.0,
            "volume": 1000000,
            "indicators": {"volatility": 0.02, "trend": 0.1, "rsi": 55},
        }
    ...
    async def test_feature_extraction_to_prediction(self):
        ...
        transits = {
            "aspects": [{"planet": "Jupiter", "type": "trine", "angle": 120}],
            "retrograde_count": 2,
            "exalted_planets": ["Jupiter"],
            "debilitated_planets": [],
            "current_positions": {
