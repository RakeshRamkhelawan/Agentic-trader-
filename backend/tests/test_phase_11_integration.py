...
class TestPhase11MarketRegimeAgentIntegration:
    ...
    def test_multiple_agents_aggregation(
        self, coordinator, mock_sentiment_agent, mock_market_regime_agent
    ):
    ...
    @pytest.mark.unit
    def test_conflicting_agent_decisions_resolved(
        self, coordinator, mock_sentiment_agent, mock_market_regime_agent
    ):
...
class TestPhase11RiskGovernorIntegration:
    ...
    @pytest.mark.unit
    def test_risk_governor_overrides_risky_decisions(
...
class TestPhase11FullE2EPipeline:
    ...
    @pytest.mark.unit
    def test_agents_to_coldpath_to_fastconfig(
        self, coordinator, mock_sentiment_agent, temp_config_file
    ):
    ...
    @pytest.mark.unit
    def test_decision_quality_from_pipeline(
        self,
        coordinator,
        mock_sentiment_agent,
        mock_market_regime_agent,
...
class TestPhase11LatencyVerification:
    ...
    @pytest.mark.unit
    def test_three_agents_decision_latency(
        self,
        coordinator,
        mock_sentiment_agent,
        mock_market_regime_agent,
...
class TestPhase11RealDecisionFlow:
    ...
    @pytest.mark.unit
    def test_mixed_signals_moderate_confidence(
        self, coordinator, mock_sentiment_agent, mock_market_regime_agent
    ):
...
class TestPhase11ConcurrentAgents:
    ...
    @pytest.mark.unit
    def test_agent_isolation_in_concurrent_scenarios(
        self, coordinator, mock_sentiment_agent, mock_market_regime_agent
    ):
...
class TestPhase11ErrorScenarios:
    ...
    @pytest.mark.unit
    def test_single_agent_failure_during_trading(
        self, coordinator, mock_sentiment_agent, mock_market_regime_agent
    ):
    ...
    @pytest.mark.unit
    def test_all_agents_fail_fallback_triggered(
        self,
        coordinator,
        mock_sentiment_agent,
        mock_market_regime_agent,
