...
# v9 Strategic Ether
from backend.agents.strategic.ether_strategic import (
...
def run_v9_strategic_backtest(use_mcts: bool = True, mcts_iterations: int = 500) -> Dict[str, Any]:
    """
    ...
    v9_collective = StrategicCollectiveConsciousness(
        use_mcts=use_mcts, mcts_iterations=mcts_iterations
    )
...
if __name__ == "__main__":
    ...
    results = run_v9_strategic_backtest(use_mcts=use_mcts, mcts_iterations=args.mcts_iter)
