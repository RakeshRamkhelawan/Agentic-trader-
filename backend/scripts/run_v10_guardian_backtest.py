...
# v10 Guardian
from backend.core.v10_guardian import V10Guardian, V10Config
...
def run_v10_guardian_backtest() -> Dict[str, Any]:
            ...
            if pos.position == 0 and sym in current_prices and \
               len(price_history[sym]["prices"]) >= 60:
                ...
                if v10_size >= 200:
                    ...
                    cost = pos.open_v10(
                        side, v10_size, market_state.price, 
                        market_state.atr, exit_params, decision
                    )
                    capital -= cost
    ...
    print("-" * 90)
    print(f"  v10 Guardian Statistics:")
