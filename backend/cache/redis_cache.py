...
class RedisCache:
    ...
    # Leaderboard caching
    def get_leaderboard(self, tier: Optional[str] = None) -> Optional[List[Dict]]:
    ...
    def invalidate_leaderboard(self, tier: Optional[str] = None) -> bool:
    ...
    # Strategy caching
    def get_strategy_list(self, query_hash: str) -> Optional[List[Dict]]:
    ...
    # Analytics caching
    def get_analytics(self, competitor_id: str, period: str) -> Optional[Dict]:
    ...
    # Chat caching
    def get_chat_history(self, tournament_id: str) -> Optional[List[Dict]]:
