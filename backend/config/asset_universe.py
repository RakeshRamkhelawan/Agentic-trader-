...
FULL_ASSET_UNIVERSE: List[TradableAsset] = [
    ...
    # ── COMMODITIES (3) ───────────────────────────────────────────────
    TradableAsset(
        "XAU/USD", AssetClass.COMMODITIES, "ccxt:oanda", 0.01, 0.01, "earth", "SUN"
    ),  # Gold
    TradableAsset(
        "XAG/USD", AssetClass.COMMODITIES, "ccxt:oanda", 1.0, 0.001, "water", "MOON"
    ),  # Silver
    TradableAsset(
        "OIL/USD", AssetClass.COMMODITIES, "ccxt:oanda", 1.0, 0.01, "fire", "MARS"
    ),  # WTI Oil
    # ── INDICES (3) ────────────────────────────────────────────────────
    TradableAsset(
        "SPX500",
