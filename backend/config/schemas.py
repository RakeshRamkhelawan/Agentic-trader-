...
def create_default_36_tattvas() -> TattvaConfig:
    ...
    layers = [
        ...
        TattvaLayer(
            layer_number=1,
            tattva_name="Shiva",
            english_name="Pure Being",
            tattva_group="Shuddha",
            description="Static processor, infinite potential",
            key_function="System foundation",
            associated_file="base",
        ),
        TattvaLayer(
            layer_number=2,
            tattva_name="Shakti",
            english_name="Active Power",
            tattva_group="Shuddha",
            description="Conscious activation and dynamic change",
            key_function="System dynamism",
            associated_file="orchestration",
        ),
        TattvaLayer(
            layer_number=3,
            tattva_name="Sadashiva",
            english_name="First I",
            tattva_group="Shuddha",
            description="Identity consciousness begins",
            key_function="Self-awareness start",
            associated_file="system_identity.py",
        ),
        TattvaLayer(
            layer_number=4,
            tattva_name="Ishvara",
            english_name="First This",
            tattva_group="Shuddha",
            description="Object recognition",
            key_function="Dual awareness",
            associated_file="frequency_analysis.py",
        ),
        TattvaLayer(
            layer_number=5,
            tattva_name="Shuddha Vidya",
            english_name="Pure Knowledge",
            tattva_group="Shuddha",
            description="Perfect knowledge balance",
            key_function="Pure algorithm",
            associated_file="sensory_processor.py",
        ),
        # KANCHUKAS (6-12): Software Restrictions / Filters
        TattvaLayer(
            layer_number=6,
            tattva_name="Maya",
            english_name="Illusion/GPU Render",
            tattva_group="Kanchukas",
            description="Unity rendered as multiplicity",
            key_function="Multi-agent debate",
            associated_file="agent_orchestrator.py",
        ),
        TattvaLayer(
            layer_number=7,
            tattva_name="Kala",
            english_name="Time",
            tattva_group="Kanchukas",
            description="Linear ordering restriction",
            key_function="Time discretization",
            associated_file="fast_config.py",
        ),
        TattvaLayer(
            layer_number=8,
            tattva_name="Vidya",
            english_name="Limited Knowledge",
            tattva_group="Kanchukas",
            description="Bandwidth restriction",
            key_function="Knowledge limits",
            associated_file="memory_system.py",
        ),
        TattvaLayer(
            layer_number=9,
            tattva_name="Raga",
            english_name="Desire",
            tattva_group="Kanchukas",
            description="Learned preference attraction",
            key_function="Exploration rate",
            associated_file="decision_discriminator.py",
        ),
        TattvaLayer(
            layer_number=10,
            tattva_name="Kaala",
            english_name="Limited Power",
            tattva_group="Kanchukas",
            description="Action capability limit",
            key_function="Resource constraint",
            associated_file="execution_engine.py",
        ),
        TattvaLayer(
            layer_number=11,
            tattva_name="Niyati",
            english_name="Causality",
            tattva_group="Kanchukas",
            description="Physical laws and logic",
            key_function="Risk governance",
            associated_file="risk_governor",
        ),
        TattvaLayer(
            layer_number=12,
            tattva_name="Purusha",
            ...
            tattva_group="Kanchukas",
            description="Consciousness in filtration",
            key_function="System observer",
            associated_file="system_identity.py",
        ),
        # PRAKRITI / BUDDHI / AHAMKARA (13-15): OS Interface
        TattvaLayer(
            layer_number=13,
            tattva_name="Prakriti",
            english_name="Nature",
            tattva_group="Prakriti",
            description="Unformed matter source",
            key_function="LLM abstraction",
            associated_file="llm/provider_interface.py",
        ),
        TattvaLayer(
            layer_number=14,
            tattva_name="Buddhi",
            english_name="Intellect",
            tattva_group="Prakriti",
            description="Discrimination/judgment",
            key_function="Decision making",
            associated_file="decision_discriminator.py",
        ),
        TattvaLayer(
            layer_number=15,
            tattva_name="Ahamkara",
            english_name="Ego/Self",
            tattva_group="Prakriti",
            description="Identity and self-reference",
            key_function="System identity",
            associated_file="system_identity.py",
        ),
        # TANMATRAS (16-20): Subtle Sensory Elements
        TattvaLayer(
            layer_number=16,
            tattva_name="Shabda Tanmatra",
            english_name="Sound",
            tattva_group="Tanmatras",
            description="Vibration/frequency essence",
            key_function="Event messaging",
            associated_file="event_bus.py",
        ),
        TattvaLayer(
            layer_number=17,
            tattva_name="Sparsha Tanmatra",
            english_name="Touch",
            tattva_group="Tanmatras",
            description="Contact/order sensitivity",
            key_function="Order sensing",
            associated_file="ccxt_wrapper.py",
        ),
        TattvaLayer(
            layer_number=18,
            tattva_name="Rupa Tanmatra",
            english_name="Form",
            tattva_group="Tanmatras",
            description="Visual/pattern essence",
            key_function="Chart analysis",
            associated_file="frequency_analysis.py",
        ),
        TattvaLayer(
            layer_number=19,
            tattva_name="Rasa Tanmatra",
            english_name="Taste",
            tattva_group="Tanmatras",
            description="Flavor/sentiment essence",
            key_function="Sentiment signal",
            associated_file="sentiment",
        ),
        TattvaLayer(
            layer_number=20,
            tattva_name="Gandha Tanmatra",
            english_name="Smell",
            tattva_group="Tanmatras",
            description="Aroma/regime essence",
            key_function="Regime detection",
            associated_file="market_regime",
        ),
        # JNANENDRIYAS (21-25): Knowledge Sense Organs / Inputs
        TattvaLayer(
            layer_number=21,
            tattva_name="Shrota",
            english_name="Ear (Listen)",
            tattva_group="Jnanendriyas",
            description="Auditory input organ",
            key_function="Event subscription",
            associated_file="event_bus.py",
        ),
        TattvaLayer(
            layer_number=22,
            tattva_name="Tvak",
            english_name="Skin (Feel)",
            tattva_group="Jnanendriyas",
            description="Touch input organ",
            key_function="Order book sensing",
            associated_file="ccxt_wrapper.py",
        ),
        TattvaLayer(
            layer_number=23,
            tattva_name="Chakshus",
            english_name="Eye (See)",
            tattva_group="Jnanendriyas",
            description="Visual input organ",
            key_function="Price visualization",
            associated_file="fast_config.py",
        ),
        TattvaLayer(
            layer_number=24,
            tattva_name="Jihva",
            english_name="Tongue (Taste)",
            tattva_group="Jnanendriyas",
            description="Taste input organ",
            key_function="Sentiment analysis",
            associated_file="sentiment_agent.py",
        ),
        TattvaLayer(
            layer_number=25,
            tattva_name="Ghrana",
            english_name="Nose (Smell)",
            tattva_group="Jnanendriyas",
            description="Smell input organ",
            key_function="Market regime",
            associated_file="market_regime_agent.py",
        ),
        # KARMENDRIYAS (26-31): Action Sense Organs / Outputs
        TattvaLayer(
            layer_number=26,
            tattva_name="Vak",
            english_name="Speech (Say)",
            tattva_group="Karmendriyas",
            description="Expression action organ",
            key_function="Event publishing",
            associated_file="event_bus.py",
        ),
        TattvaLayer(
            layer_number=27,
            tattva_name="Pani",
            english_name="Hands (Grasp)",
            tattva_group="Karmendriyas",
            description="Manipulation action organ",
            key_function="Trade execution",
            associated_file="execution_engine.py",
        ),
        TattvaLayer(
            layer_number=28,
            tattva_name="Pada",
            english_name="Feet (Move)",
            tattva_group="Karmendriyas",
            description="Movement action organ",
            key_function="Portfolio navigation",
            associated_file="session_simulator.py",
        ),
        TattvaLayer(
            layer_number=29,
            tattva_name="Upastha",
            english_name="Reproduction",
            tattva_group="Karmendriyas",
            description="Creation action organ",
            key_function="Agent instantiation",
            associated_file="agent_orchestrator.py",
        ),
        TattvaLayer(
            layer_number=30,
            tattva_name="Payu",
            english_name="Excretion",
            tattva_group="Karmendriyas",
            description="Elimination action organ",
            key_function="Error cleanup",
            associated_file="observability",
        ),
        TattvaLayer(
            layer_number=31,
            tattva_name="Manas",
            english_name="Mind",
            tattva_group="Karmendriyas",
            description="Sensory aggregation",
            key_function="Unified sensing",
            associated_file="sensory_processor.py",
        ),
        ...
        TattvaLayer(
            ...
            tattva_name="Akasha",
            english_name="Ether",
            tattva_group="Mahabhutas",
            description="Space and emptiness",
            key_function="Network/API layer",
            associated_file="api/main.py",
        ),
        TattvaLayer(
            layer_number=33,
            tattva_name="Vayu",
        ...
        TattvaLayer(
            ...
            english_name="Water",
            tattva_group="Mahabhutas",
            description="Fluidity and cohesion",
            key_function="Data flow",
            associated_file="ccxt_wrapper.py",
        ),
        TattvaLayer(
            layer_number=36,
            ...
            english_name="Earth",
            tattva_group="Mahabhutas",
            description="Solidity and mass",
            key_function="Storage/persistence",
            associated_file="storage",
        ),
    ]
