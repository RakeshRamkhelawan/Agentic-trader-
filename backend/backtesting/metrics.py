...
class MetricsCalculator:
    ...
    @staticmethod
    def calculate(equity_curve: List[Dict], initial_capital: float, trades: List[Trade] = None) -> BacktestMetrics:
        ...
        if len(downside_returns) > 0:
            ...
            sortino = (annual_return - MetricsCalculator.RISK_FREE_RATE) / (downside_std * np.sqrt(252)) if downside_std > 0 else 0.0
        else:
