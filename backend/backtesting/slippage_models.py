...
class VolumeSlippageModel(SlippageModel):
    ...
    def apply(self, price: float, quantity: float, side: OrderSide, 
              avg_bar_volume: float = 1000.0) -> tuple:
        ...
        volume_impact_bps = min(100, self.base_bps + (volume_ratio * self.impact_factor * 10000))
