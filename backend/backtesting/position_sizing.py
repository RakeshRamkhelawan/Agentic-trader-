...
class PositionSizer(ABC):
    ...
    @abstractmethod
    def calculate_quantity(self, signal_strength: float, price: float, 
                          portfolio_value: float, risk_per_trade: float = 0.01) -> float:
...
class RiskBasedSizer(PositionSizer):
    ...
    def calculate_quantity(self, signal_strength: float, price: float, 
                          portfolio_value: float, risk_per_trade: float = 0.01,
...
class KellyCriterionSizer(PositionSizer):
    ...
    def __init__(self, win_rate: float = 0.55, avg_win: float = 1.0, 
                 avg_loss: float = 1.0, fractional_kelly: float = 0.25):
