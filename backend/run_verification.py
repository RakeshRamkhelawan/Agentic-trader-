...
def main():
    ...
    # Define test groups
    test_groups = {
        "Foundational Types": ["backend/tests/test_ooda_types.py"],
        "Designated Agents": ["backend/tests/test_agents_specialized.py"],
        ...
        "RAG & Memory": ["backend/tests/test_rag_vector_memory.py"],
    }
