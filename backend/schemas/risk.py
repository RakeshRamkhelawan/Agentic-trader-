...
class RiskProfile(BaseModel):
    ...
    # Asset Controls
    allowed_assets: List[str] = Field(default_factory=list, description="Whitelist of symbols (e.g. ['BTC-EUR', 'ETH-EUR'])")
    ...
    # Advanced
    max_drawdown_pct: float = Field(5.0, description="Max portfolio drawdown percentage before stopping")
