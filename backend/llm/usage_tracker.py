...
class TokenCounter:
    ...
    def calculate_cost(self, prompt_tokens: int, completion_tokens: int, model: str) -> float:
        ...
        pricing = {
            ...
            'gemini-1.5-pro': {'prompt': 0.00125 / 1000, 'completion': 0.005 / 1000}, # Approximate
            'gemini-1.0-pro': {'prompt': 0.0005 / 1000, 'completion': 0.0015 / 1000},
        }
        
        # Normalize model name for pricing lookup
        pricing_model = model
        if 'gpt-4' in model and 'turbo' not in model: pricing_model = 'gpt-4'
        elif 'gpt-4' in model and 'turbo' in model: pricing_model = 'gpt-4-turbo'
        elif 'gpt-3.5' in model: pricing_model = 'gpt-3.5-turbo'
        elif 'gemini-1.5' in model: pricing_model = 'gemini-1.5-pro'
        elif 'gemini' in model: pricing_model = 'gemini-1.0-pro'
