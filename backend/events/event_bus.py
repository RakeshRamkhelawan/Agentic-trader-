...
class EventBus:
    ...
    async def publish(self, stream: str, event_data: Dict[str, Any]) -> str:
        ...
        message = {k: json.dumps(v, default=str) if isinstance(v, (dict, list)) else str(v) 
            ...
            for stream_name, stream_messages in response:
                for message_id, message_data in stream_messages:
                    ...
                    messages.append({
                        ...
                        "data": parsed_data,
                        "stream": stream.decode() if isinstance(stream_name, bytes) else stream_name,
                    })
    ...
    async def _schedule_retry(self, original_stream: str, event_data: Dict[str, Any], error: str) -> None:
        """
    ...
    async def _send_to_dlq(self, original_stream: str, event_data: Dict[str, Any], error: str) -> None:
