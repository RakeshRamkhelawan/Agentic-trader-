...
class ElementalAgentManagerV3:
            ...
            if len(prices) >= 14:
                ...
                if atr_pct > 4.0:
                    return FireDecision(
                        ...
                        risk_score=1.0, blocking_reasons=["TSLA ATR > 4% - too volatile"],
                        var_estimate_pct=0, fire_dharma="Agni: TSLA volatility too high",
    ...
    def ether_agent_synthesize(self, fire: FireDecision, water: WaterRegime,
        ...
        agents_above_baseline = sum(
            ...
            if conf > 0.55  # Above typical operating level
        )
