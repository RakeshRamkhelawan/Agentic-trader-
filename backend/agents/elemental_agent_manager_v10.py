"""
Elemental Agent Manager V10 - CALIBRATED REVIEW SENSITIVITY

V10 Key Changes:
- Earth: EXIT drempel 0.60 (was 0.75) + minimum 5 dagen holding
- Fire: Minimum 10 dagen window + vol_ratio > 4.0 (was 2.5/3.0) en > 6.0 (was 4.0/5.0)
- Ether: Lagere thresholds voor hogere execute rate (12-20% target)
- Position review minder agressief, trades kunnen langer lopen

Fire Agent sizing ONGEWIJZIGD van v8/v9
"""
...
logger = logging.getLogger("ElementalAgentsV10")
...
# ============ V10: EARTH AGENT - CALIBRATED EXIT ============

class EarthAgentV10:
    """Earth Agent with calibrated position review"""
    
    def __init__(self):
        self.symbol_memory: Dict[str, deque] = defaultdict(lambda: deque(maxlen=20))
        self.win_rates: Dict[str, float] = {}
        
        # V10: Entry tracking with dates
    ...
    def evaluate_open_position(self, symbol: str, current_date: datetime) -> str:
        ...
        # V10: Strengere drempel: 0.60 (40% daling vereist)
...
# ============ V10: FIRE AGENT - CALIBRATED EXIT ============
...
# ============ V10: WATER AGENT - CALIBRATED EXIT ============

class WaterAgentV10:
    """Water Agent with calibrated position review"""
    ...
    def calculate_confidence(self, symbol: str, macro_signal: MacroSignal) -> float:
        """V10: Confidence with macro regime awareness"""
        asset_class = self._get_asset_class(symbol)
    ...
    def evaluate_open_position(self, symbol: str, macro_signal: MacroSignal) -> str:
        """
        V10: Water evalueert regime-shift
        - Crypto: 0.35 (was 0.25/0.30)
        - Equity: 0.50 (was 0.35/0.45)
        """
        ...
        # V10: Verhoogde drempels (minder agressief)
...
# ============ V10: ETHER ORCHESTRATOR ============

class EtherOrchestratorV10:
...
class ElementalAgentManagerV10:
    """V10: Calibrated Review Sensitivity"""
    
    SLIPPAGE_PCT = 0.001
    COMMISSION_PCT = 0.0005
    
    def __init__(self):
        self.fire_agent = FireAgentV10()
        self.water_agent = WaterAgentV10()
        self.air_agent = AirAgentV10()
        self.earth_agent = EarthAgentV10()
        self.ether_orchestrator = EtherOrchestratorV10()
