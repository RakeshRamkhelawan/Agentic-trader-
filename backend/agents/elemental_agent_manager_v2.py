...
class ElementalAgentManagerV2:
    ...
    def fire_agent_assess(self, symbol: str, proposed_action: str,
        ...
        if harmony_score < threshold * 0.8:  # Even Fire uses adjusted threshold
            return FireDecision(
                ...
                risk_score=0.9, blocking_reasons=[f"Harmony {harmony_score:.2f} < threshold {threshold:.2f}"],
        ...
        return FireDecision(
            ...
            var_estimate_pct=var_estimate, fire_dharma=dharma_messages.get(decision, "Agni observeert"),
            prana_consumed=PRANA_COSTS["risk"]
        )
    ...
    def water_agent_analyze(self, symbol: str, market_data: Dict[str, Any],
        ...
        narratives = {
            ...
            "contraction": f"Contractie fase - defensief",
    ...
    def ether_agent_synthesize(self, fire: FireDecision, water: WaterRegime,
        ...
        unique_actions = len(set([
            ...
            water.regime, air.action, earth.verdict
        ]))
