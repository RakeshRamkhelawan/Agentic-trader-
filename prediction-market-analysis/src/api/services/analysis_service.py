...
class AnalysisService:
    ...
    def analyze_market(
        ...
        try:
            ...
            if spread_metrics:
                ...
                logger.info(f"Spread analysis complete: {spread_metrics.liquidity_score:.1f}/100 liquidity")
            else:
        ...
        try:
            ...
            if volume_metrics:
                ...
                logger.info(f"Volume analysis complete: {volume_metrics.volume_trend} trend")
            else:
        ...
        try:
            ...
            if price_series is not None:
                price_tests = {
                    "normality_test": self.stat_framework.test_normality(price_series).to_dict(),
                    "stationarity_test": self.stat_framework.test_stationarity(price_series).to_dict(),
                }
    ...
    def compare_markets(
        ...
        for market_name, df in markets_data.items():
            ...
            results[market_name] = {
                "trades_count": len(df),
                "liquidity_score": spread_metrics.liquidity_score if spread_metrics else 0,
                "volume_trend": volume_metrics.volume_trend if volume_metrics else "unknown",
