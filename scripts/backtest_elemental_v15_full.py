"""
Elemental System Backtest V15 - FULL RUN (2020-2026)
Risk Management & Profit Protection Edition
"""
...
logger = logging.getLogger("BacktestV15Full")

from scripts.backtest_elemental_v15 import V15BacktestEngine
...
def main():
    """Run full V15 backtest (2020-2026)"""
    
    logger.info("=" * 70)
    logger.info("V15 FULL BACKTEST: 2020-2026 (50 Assets)")
    logger.info("Risk Management & Profit Protection")
    logger.info("=" * 70)
    ...
    # Save results
    output_file = f"backtest_v15_full_2020_2026_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
