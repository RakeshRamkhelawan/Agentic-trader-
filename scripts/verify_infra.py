...
class InfrastructureVerifier:
    def __init__(self, verbose: bool = False):
        ...
        self.config = {
            ...
            'postgres_dsn': 'postgresql://trader:trading_secure@localhost:5432/trading_db',
    ...
    async def check_postgres(self) -> ServiceCheck:
        ...
        try:
            ...
            return ServiceCheck(
                ...
                endpoint=self.config['postgres_dsn'].split('@')[1]
            )
            ...
            return ServiceCheck(
                ...
                latency_ms=round(latency, 2),
                details=f"Error: {str(e)[:100]}",
                endpoint=self.config['postgres_dsn'].split('@')[1] if '@' in self.config['postgres_dsn'] else 'N/A'
            )
    ...
    def render_results(self):
        ...
        for result in self.results:
            ...
            print(f"{result.name:<25} {symbol:<12} {result.latency_ms:<15.2f} {result.details[:30]:<30}")
            if self.verbose:
