...
print(
    f"V14: {data['elemental_cycles']:,} cycles -> {data['total_trades']} trades ({data['total_return_pct']:+.2f}%)"
)
print(
    f"Efficiency: {data['total_trades']/data['elemental_cycles']*100:.2f}% of cycles become trades"
)
