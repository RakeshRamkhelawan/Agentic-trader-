...
print("-" * 65)
print(f"{'Return':<25} {'+69.81%':>12} {f"+{data['total_return_pct']:.2f}%":>12} {f"+{data['total_return_pct']-69.81:.2f}%":>12}")
print(f"{'Sharpe':<25} {'0.61':>12} {data['sharpe_ratio']:>12.2f} {f"+{data['sharpe_ratio']-0.61:.2f}":>12}")
print(f"{'Cycles':<25} {'4,427':>12} {f"{data['elemental_cycles']:,}":>12} {'Preserved':>12}")
print(f"{'Trades':<25} {'1,152':>12} {f"{data['total_trades']}":>12} {f"{data['total_trades']-1152:+d}":>12}")
print()
...
if max_sizes:
    ...
    if overall_max <= 2000:
        print(f"  [OK] All positions within €2,000 cap!")
