            ...
            for symbol in self.symbols['bitvavo']:
                try:
                    ...
                    if ticker and ticker.get('last'):
                        ...
                        # Broadcast price
                        await paper_trading_broadcaster.broadcast_price_update(symbol, price, 'bitvavo')
                except:
                    pass
            ...
            for symbol in self.symbols['revolut']:
                try:
                    ...
                    if ticker and ticker.get('last'):
                        ...
                        await paper_trading_broadcaster.broadcast_price_update(symbol, price, 'revolut')
                except:
                    pass
