"""
Elemental System Backtest V14 - FULL RUN (2020-2026)
Cycle Restoration - Goal: 4,000+ cycles like V10
"""
...
logger = logging.getLogger("BacktestV14Full")

from scripts.backtest_elemental_v14 import V14BacktestEngine
...
def main():
    """Run full V14 backtest (2020-2026)"""
    
    logger.info("=" * 70)
    logger.info("V14 FULL BACKTEST: 2020-2026 (50 Assets)")
    logger.info("Cycle Restoration - Target: 4,000+ cycles")
    logger.info("=" * 70)
    ...
    # Save results
    output_file = f"backtest_v14_full_2020_2026_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
