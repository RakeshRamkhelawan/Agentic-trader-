#!/usr/bin/env python3
"""Debug V14 trade issues - new run"""
import json

with open('backtest_v14_full_2020_2026_20260221_235716.json', 'r') as f:
    data = json.load(f)
...
print(f'Win Rate: {len(winners)/len(sells)*100:.1f}%')
...
print('\nSample WINNER trades:')
for t in winners[:5]:
    print(f"  {t['symbol']}: PnL=${t.get('realized_pnl'):.2f}")
