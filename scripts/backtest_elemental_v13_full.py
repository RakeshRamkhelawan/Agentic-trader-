"""
Elemental System Backtest V13 - FULL RUN (2020-2026)
Fixed cycle counting + COIN threshold fix.
"""
...
logger = logging.getLogger("BacktestV13Full")

from scripts.backtest_elemental_v13 import V13BacktestEngine
...
def main():
    """Run full V13 backtest (2020-2026)"""
    
    logger.info("=" * 70)
    logger.info("V13 FULL BACKTEST: 2020-2026 (50 Assets)")
    logger.info("Cycle Fix + COIN Threshold Fix")
    logger.info("=" * 70)
    ...
    # Save results
    output_file = f"backtest_v13_full_2020_2026_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
