    ...
    async with AsyncSessionLocal() as db:
        ...
        if adapter:
            try:
                ...
                etfs = [i for i in instruments if any(x in str(i).upper() for x in ["ETF", "TRUST", "FUND"])]
            ...
            logger.error("No Revolut adapter found. Check your .env for REVOLUT_API_KEY and REVOLUT_PRIVATE_KEY")
