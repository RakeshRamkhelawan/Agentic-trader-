...
logger = logging.getLogger("BacktestV10")

from backend.agents.elemental_agent_manager_v10 import (
    ElementalAgentManagerV10, MacroSignal, IPO_DATES
)
...
class V10BacktestEngine:
    ...
    def __init__(
        ...
        self.agent_manager = ElementalAgentManagerV10()
        ...
        logger.info("=" * 60)
        logger.info("V10: CALIBRATED REVIEW SENSITIVITY")
        logger.info("=" * 60)
    ...
    def run_backtest(self) -> V10BacktestResult:
    ...
    def _generate_result(self, price_data: Dict) -> V10BacktestResult:
        ...
        logger.info("\n" + "=" * 60)
        logger.info("V10 BACKTEST RESULTS")
        logger.info("=" * 60)
...
def main():
    ...
    output_file = f"backtest_v10_2021_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
