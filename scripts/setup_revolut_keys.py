...
def generate_keys():
    ...
    try:
        ...
        print(
            "WAARSCHUWING: Deel dit bestand met niemand en commit het NIET naar Git.\n"
        )
    except IOError as e:
        print(
            f"FOUT: Kon de private key niet opslaan in {file_path}. Controleer schrijfrechten. Details: {e}"
        )
        sys.exit(1)
