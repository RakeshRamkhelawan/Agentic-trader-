...
try:
    ...
    print(f'      [OK] EternalSoulService geïmporteerd')
...
try:
    ...
    print(f'      [OK] CognitiveMindService geïmporteerd')
...
try:
    ...
    print(f'      [OK] ReflexExecutor geïmporteerd')
...
print(f'   [INFO] Action mapping: 0=HOLD, 1=BUY, -1=SELL')
