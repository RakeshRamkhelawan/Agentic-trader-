...
session_files = [f for f in os.listdir('.') if f.startswith('real_paper_session_') and f.endswith('.json')]
...
if not session_files:
    ...
    try:
        ...
        if 'stats' in data:
            ...
            print(f'      Buy/Sell: {stats.get("buy_trades", 0)}/{stats.get("sell_trades", 0)}')
